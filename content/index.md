...
SCION runs on many different platforms and works with different network configurations. We cover all approaches with different tutorials. To choose the correct tutorial for your setup, follow the flowchart below to determine the number of the tutorial suited for you.
